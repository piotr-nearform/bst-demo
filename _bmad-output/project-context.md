...
6. **Honour these constraints in every workflow.** They apply across PRD, architecture, story, dev, and review. If a constraint blocks the obvious approach, surface it, do not silently work around it.
